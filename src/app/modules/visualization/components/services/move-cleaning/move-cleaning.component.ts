...
@Component({
  selector: 'app-move-cleaning',
  templateUrl: './move-cleaning.component.html',
  styleUrls: ['./move-cleaning.component.scss']
})
export class MoveCleaningComponent implements AfterViewInit{
