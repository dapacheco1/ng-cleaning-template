...
@Component({
  selector: 'app-vacation-cleaning',
  templateUrl: './vacation-cleaning.component.html',
  styleUrls: ['./vacation-cleaning.component.scss']
})
export class VacationCleaningComponent implements AfterViewInit{
