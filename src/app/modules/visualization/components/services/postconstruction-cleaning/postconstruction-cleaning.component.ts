...
@Component({
  selector: 'app-postconstruction-cleaning',
  templateUrl: './postconstruction-cleaning.component.html',
  styleUrls: ['./postconstruction-cleaning.component.scss']
})
export class PostconstructionCleaningComponent implements AfterViewInit{
